...
using MapMakerApplication.Views;
...
namespace MapMakerApplication
{
    public class ApplicationController
    {
        ...
        public static UODataManager manager;//=new UODataManager(new Uri(@"C:\Ultima\Clients\ML"), UODataType.ClassicStygianAbyss, Language.English, false);
